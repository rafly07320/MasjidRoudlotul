    ...
    <div class="grid grid-cols-3 gap-4 mt-4">
        <div
            ...
            <div class="flex flex-col gap-4">
                <h2 class="md:text-2xl text-2xl font-medium text-center text-gray-900 dark:text-white">
                    Jumlah Jiwa
                </h2>
                <h2 class="md:text-2xl text-2xl font-medium text-center text-green-500 dark:text-white">
                    {{ $total_jiwa }}
                </h2>
            </div>
        </div>
