...
@section('content')
    <div style="background-image: url('{{ Storage::url('foto_artikels/' . $artikel->foto_artikel) }}');"
        ...
        <div class="px-4 mx-auto max-w-screen-xl flex  flex-col items-center h-full justify-center">
            ...
            <p class="mb-8 text-lg font-normal text-gray-300">
                {{ \Carbon\Carbon::parse($artikel->tanggal_artikel)->format('d M Y') }}
            </p>
        </div>
    </div>
    <div>
        <div class="px-4 mx-auto max-w-screen-xl flex flex-col lg:flex-row ">
            <div class="lg:w-3/4 w-full">
                <div class="flex justify-center items-center my-8">
                    <img class="rounded-t-lg lg:h-96 h-auto" src="{{ Storage::url('foto_artikels/' . $artikel->foto_artikel) }}"
                        alt="">
                </div>
