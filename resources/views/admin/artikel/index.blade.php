                ...
                <tbody>
                    @foreach ($artikels as $artikel)
                        <tr>
                            ...
                            <td>{{ $artikel->tanggal_artikel }}</td>
                            <td class="whitespace-normal break-words">{{ $artikel->deskripsi_artikel }}</td>
                            <td><img src="{{ Storage::url('foto_artikels/' . $artikel->foto_artikel) }}" alt="Foto Artikel">
                            </td>
                            <td>
                ...
                <form action="{{ route('artikel.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="deskripsi_artikel" name="deskripsi_artikel" rows="4"
                        ...
                        <div class="p-4 md:p-5 space-y-4">
                            ...
                            <div class="mb-4">
                                ...
                                @if ($artikel->foto_artikel)
                                    <img src="{{ asset('storage/' . $artikel->foto_artikel) }}" alt="Foto Artikel"
                                        class="mt-2 max-w-xs">
                                @endif
                            </div>
                        </div>
