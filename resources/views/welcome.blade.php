...
@section('content')
        ...
        <div class="relative h-56 overflow-hidden rounded-lg md:h-custom-2">
            ...
            <div class="absolute inset-0 flex items-center justify-center text-white z-40 bg-black/60">
                <div class="text-center">
                    ...
                    <p class="text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:mx-56">Jl Dupak Baru III No. 43
                        Surabaya</p>
                </div>
            </div>
    ...
    <div class="my-8">
        <h2 class="p-4 font-poppins underline md:text-6xl text-2xl font-black text-center text-gray-900 dark:text-white">
            Sejarah Masjid
        </h2>
    </div>
    <div class="bg-brush mt-10 shadow-inner-lg md:w-3/4 mx-auto rounded-xl">
        <div class="flex flex-col md:flex-row  mx-auto md:max-w-screen-xl h-auto">
            ...
            <div class="md:w-1/2 w-full h-96 my-20 py-5 justify-center align-items-center flex flex-col">
                <h2 class="text-2xl font-black text-gray-900 mb-5 text-center md:text-start">
                    MASJID ROUDLOTUL ULUM SURABAYA
                </h2>
                <p class=" font-poppins text-justify md:mx-0 md:mr-10 px-5 md:px-0 mb-10 md:mb-0">
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                            <img class="rounded-t-lg"
                                src="{{ Storage::url('foto_kegiatans/' . $kegiatan->foto_kegiatan) }}" alt="" />
                        </a>
                        <div class="p-5">
                            <a
